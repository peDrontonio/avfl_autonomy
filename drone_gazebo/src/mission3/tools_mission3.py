...
class Tools(Node):
    def __init__(self) -> None:
        super().__init__('tools_mission3_node')
    ...
    def setServer(self):
        self.create_service(Trigger, '/start_mission3', self.start_mission_callback, callback_group=self.service_cb_group)
    ...
    def start_mission_callback(self, request, response):
        ...
        self.get_logger().info("Initializing Mission 3 - Mobile Base Landing (YOLO)")
