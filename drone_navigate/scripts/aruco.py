...
# --- CALIBRAÇÃO ATUALIZADA (Valores Reais) ---
# Matriz Intrínseca (K)
...
class DroneTrackerNode(Node):
    def __init__(self):
        ...
        # Subscriber
        # Verifique se o tópico '/camera/image' é o correto para sua câmera real
        # Na Jetson/Raspberry pode ser algo como '/camera_baixo' ou '/image_raw'
        ...
        self.get_logger().info("Drone Tracker Node INICIADO (Calibração Real + Dict 4x4).")
    ...
    def image_callback(self, msg):
        ...
        if ids is not None and len(ids) > 0:
            ...
            for i in range(len(ids)):
                img_pts = corners[i][0]
                # Aqui usamos as matrizes reais para calcular a pose correta
            ...
            if should_log:
                ...
                self.get_logger().info(f" VISUAL: {count} ArUcos detected (Dict 4x4)")
